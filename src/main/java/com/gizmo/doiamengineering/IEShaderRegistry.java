...
//				registerShaderCases("Auroralized", ModType.IMMERSIVE_ENGINEERING, "1_5", RARITY, 0xFF_00_FF_FF, 0xFF_00_FF_00, 0xFF_00_00_FF, 0xFF_FF_FF_FF, (m, t, s, c) -> new ShaderConsumerLayer( m.provideTex(t, s), 0xFFFFFFFF, AURORA_TRICONSUMER, ShaderManager.Uniforms.TIME_UNIFORM)).setInfo("Twilight Forest", "Aurora Palace", "aurora"),
				...
				registerShaderCases("Knightmetal", ModType.IMMERSIVE_ENGINEERING, "1_0", RARITY, 0xFF_E7_FC_CD, 0xFF_4D_4C_4B, 0xFF_80_8C_72, 0xFF_FF_FF_FF, LAYER_PROVIDER).setInfo("Twilight Forest", "Knightmetal", "knightmetal"),
...
//				registerShaderCases("Cube of Annihilation", ModType.IMMERSIVE_ENGINEERING, "1_0", RARITY, 0xFF_00_00_03, 0xFF_14_00_40, 0xFF_00_00_03, 0xFF_14_00_40, (m, t, s, c) -> new ShaderConsumerLayer( m.provideTex(t, s), 0xFF_14_00_40, OUTLINE_TRICONSUMER, ShaderHelper.TIME_UNIFORM)).setInfo("Twilight Forest", "Cube of Annilation", "cube_of_annilation"),
		...
		listBuilder.add(
				registerShaderCases("Quest Ram", ModType.TWILIGHT_FOREST, "streaks", RARITY, 0xFF_F9_E1_C8, 0xFF_9A_85_69, 0xFF_2F_2B_36, 0xFF_90_D8_EF, LAYER_PROVIDER, (m, t, s, c) -> new ShaderConsumerLayer(ModType.IMMERSIVE_ENGINEERING.provideTex(t, "circuit"), 0x30_90_D8_EF, RAM_TRICONSUMER, ShaderManager.Uniforms.STAR_UNIFORMS)).setInfo("Twilight Forest", "Quest Ram", "quest_ram"),
				...
				registerShaderCases("Alpha Yeti", ModType.IMMERSIVE_ENGINEERING, "1_0", RARITY, 0xFF_FC_FC_FC, 0xFF_4A_80_CE, 0xFF_25_3F_66, 0xFF_FF_FF_FF, LAYER_PROVIDER).setInfo("Twilight Forest", "Alpha Yeti Miniboss", "alpha_yeti"),
				registerShaderCases("Snow Queen", ModType.IMMERSIVE_ENGINEERING, "1_0", RARITY, 0xFF_DC_FB_FF, 0xFF_C3_9C_00, 0xFF_03_05_89, 0xFF_FF_FF_FF, LAYER_PROVIDER).setInfo("Twilight Forest", "Snow Queen Boss", "snow_queen")
		);
